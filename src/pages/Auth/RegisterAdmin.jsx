...
const INVITE_REGISTER_TOKEN = "JE5U5_L0V35_U";
...
const RegisterAdmin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `${BASE_URL}/store/${id}/register?token=${INVITE_REGISTER_TOKEN}`,
                {
                    method: 'POST',
                    headers: {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            <h1 className='text-center mb-4 font-body text-6xl font-normal text-Heading font-darker-grotesque text-black'>
                MyDuk
            ...
            <div className="container-9xl max-w-full p-4 bg-white border p-2 rounded-[12px]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 max-w-max">
                    ...
                    <div>
                        <label htmlFor="image" className="block text-sm font-semibold font-darker-grotesque text-4.5xl text-black bg-white">Profile Image (Optional)</label>
                        <input 
                            type="file"
                            id="image"
