...
<Link to="/clerk/dashboard" className="sidebar-link block py-2 px-4 font-semibold rounded hover:bg-red-700 transition duration-300" onClick={toggleSidebar}>
  Home
</Link>
</li>
<li className="sidebar-item">
<Link to="/clerk/register-product" className="sidebar-link block py-2 px-4 font-semibold rounded hover:bg-red-700 transition duration-300" onClick={toggleSidebar}>
  Add Products
</Link>
</li> */}